package com.zarkaoui.converter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] devises = {"EURO", "USD", "AED", "CAD", "TL"};
...
//                }
                ...
                if(devise.equals("EURO")){
                    ...
                    result = amount * 0.66;
                    data.add(amount + " TL = " + String.format("%.2f", result));
                }
                ...
                stringArrayAdapter.notifyDataSetChanged(); //informe la vue
